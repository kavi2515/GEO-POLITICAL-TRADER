...
COUNTRY_MARKETS: dict[str, dict] = {
    "russia": {
        "currency": "RUB", "commodities": ["OIL/BRENT", "NATGAS", "WHEAT"],
        "stocks": ["BP", "SHEL", "XOM", "CVX", "TTE"],
    },
    "ukraine": {
        "currency": "UAH", "commodities": ["WHEAT", "CORN"],
        "stocks": ["LMT", "RTX", "NOC"],
    },
    "china": {
        "currency": "CNY", "indices": ["CSI300", "HSI"], "commodities": ["COPPER", "IRON_ORE"],
        "stocks": ["BABA", "AAPL", "NVDA", "TSM", "ASML", "QCOM"],
    },
    "united states": {
        "currency": "USD", "indices": ["SPX500", "NASDAQ"],
        "stocks": ["AAPL", "MSFT", "NVDA", "GOOGL", "AMZN", "META", "JPM", "GS", "XOM"],
    },
    "usa": {
        "currency": "USD", "indices": ["SPX500", "NASDAQ"],
        "stocks": ["AAPL", "MSFT", "NVDA", "GOOGL", "AMZN", "META", "JPM", "GS"],
    },
    "america": {
        "currency": "USD", "indices": ["SPX500", "NASDAQ"],
    ...
    "iran": {
        "commodities": ["OIL/BRENT"], "currency": "IRR",
        "stocks": ["XOM", "CVX", "COP", "BP", "SHEL"],
    },
    "saudi arabia": {
        "currency": "SAR", "commodities": ["OIL/BRENT", "OIL/WTI"],
        "stocks": ["XOM", "CVX", "COP", "BP", "SHEL", "TTE"],
    },
    "opec": {
        "commodities": ["OIL/BRENT", "OIL/WTI"],
        "stocks": ["XOM", "CVX", "BP", "SHEL", "TTE"],
    },
    "europe": {
        "currency": "EUR", "indices": ["DAX", "FTSE100"],
        "stocks": ["BP", "SHEL", "SAP", "ASML", "TTE"],
    },
    "european union": {
        "currency": "EUR", "indices": ["DAX"],
        "stocks": ["SAP", "ASML", "TTE"],
    },
    "japan": {"currency": "JPY", "indices": ["NIKKEI225"], "stocks": ["TM"]},
    "uk": {
        "currency": "GBP", "indices": ["FTSE100"],
        "stocks": ["BP", "SHEL", "RIO", "BHP"],
    },
    "united kingdom": {
        "currency": "GBP", "indices": ["FTSE100"],
        "stocks": ["BP", "SHEL", "RIO", "BHP"],
    ...
    "brazil": {
        "currency": "BRL", "commodities": ["SOYBEANS", "IRON_ORE", "COFFEE"],
        "stocks": ["RIO", "BHP", "FCX"],
    },
    "turkey": {"currency": "TRY"},
    "israel": {
        "currency": "ILS", "commodities": ["OIL/BRENT"],
        "stocks": ["CHKP", "LMT", "RTX"],
    },
    "north korea": {
        "safe_haven": True,
        "stocks": ["CRYPTO/BTC", "CRYPTO/ETH"],  # NK uses crypto to evade sanctions
    },
    "venezuela": {
        "commodities": ["OIL/BRENT"], "currency": "VES",
        "stocks": ["CRYPTO/BTC", "CRYPTO/ETH"],  # crypto adoption driven by hyperinflation
    },
    "middle east": {
        "commodities": ["OIL/BRENT", "OIL/WTI"],
        "stocks": ["XOM", "CVX", "COP", "BP", "SHEL", "TTE", "LMT", "RTX"],
    },
    "taiwan": {
        "currency": "TWD", "indices": ["SEMICONDUCTORS"],
        "stocks": ["TSM", "ASML", "NVDA", "AAPL", "QCOM", "AMD"],
    },
    "south korea": {
        "currency": "KRW",
        "stocks": ["TSM"],
    },
    "germany": {"currency": "EUR", "indices": ["DAX"], "stocks": ["SAP"]},
    "france": {"currency": "EUR", "stocks": ["TTE"]},
    "pakistan": {"currency": "PKR"},
    "afghanistan": {"safe_haven": True},
    "africa": {
        "commodities": ["GOLD", "COPPER", "PLATINUM"],
        "stocks": ["NEM", "FCX", "RIO", "BHP"],
    },
    "latin america": {
        "commodities": ["SOYBEANS", "COPPER", "OIL/BRENT"],
        "stocks": ["FCX", "RIO", "BHP"],
    },
}
